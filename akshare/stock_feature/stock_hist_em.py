...
def code_id_map_em() -> dict:
    ...
    while True:
        ...
        code_id_dict.update(dict(zip(temp_df["sh_code"], temp_df["sh_id"])))
    ...
    while True:
        ...
        temp_df = pd.DataFrame(data_json["data"]["diff"])
        temp_df["sz_id"] = 0
        code_id_dict.update(dict(zip(temp_df["f12"], temp_df["sz_id"])))
        if data_json["data"]["total"] < page_number * page_size:
            break
        page_number += 1
    ...
    while True:
        ...
        temp_df = pd.DataFrame(data_json["data"]["diff"])
        temp_df["bj_id"] = 0
        code_id_dict.update(dict(zip(temp_df["f12"], temp_df["bj_id"])))
        if data_json["data"]["total"] < page_number * page_size:
            break
        page_number += 1
    return code_id_dict
